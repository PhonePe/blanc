...
Exposes the same async surface as :class:`~blanc.core.rag_client.vector_db.VectorDBClient`
...
Chunks arrive from ``blanc.core.rag_client.chunker.generate_appsec_chunks``
...
from blanc.core.rag_client.embeddings import Embedder, build_embedder
...
class LocalVectorDB:
    ...
    Constructed via :func:`blanc.core.rag_client.factory.get_rag_client`;
