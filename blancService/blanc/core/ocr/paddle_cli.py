...
# blancService/blanc/core/ocr/paddle_cli.py
#   parents[0] = ocr/
#   parents[1] = core/
#   parents[2] = blanc/
...
# PP-OCRv6 weights ship with the package under blanc/core/ocr/ocr_models/.
...
# CLI-only safety net: blanc.config_parsers reads ENV at import time.
