...
from blanc.util.file_sniff import is_image_bytes, is_pdf_bytes
...
from blanc.core.rag_client.extractor import extract_images_from_pdf_bytes
...
def submit_answers(
    ...
    """
    from blanc.db_models.models import AssessmentState, DocumentAnalysis as DA
