...
class SearchRequest(BaseModel):
    ...
    environment: Optional[str] = Field(
        default=None, description="Target environment filter (e.g., staging, prod)"
    )
    document_type: Optional[str] = Field(
        default=None, description="Filter by doc type (e.g., threat_model)"
    )
