...
from atm.db.database import get_db, engine
from atm.core.auth.auth import require_assessment_owner, require_roles
...
from atm.api_schemas.api_v1.threat_modeling_schema import (
...
# atm/api_schemas/api_v1/threat_modeling_schema.py.
...
def generate_surface_map_endpoint(
    ...
    from atm.core.document_analysis import surface_discovery
