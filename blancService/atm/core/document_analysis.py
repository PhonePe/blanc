...
from atm.core.ocr import should_run_paddle_ocr
from atm.core.state_machine import transition_image
...
def _image_to_mermaid_with_ocr(
    ...
    from atm.core.ocr import extract_ocr_context
...
#    atm/skills/definitions/surface_discovery.md.
...
def analyze_single_image_phase_a(
    ...
    try:
        ...
        logging.exception(f"[{assessment_id}][img:{image_id}] Error during Phase A: {e}")
...
def analyze_single_image_phase_a_from_mermaid(
    ...
    try:
        ...
        logging.exception(f"[{assessment_id}][img:{image_id}] Error during Phase A (from mermaid): {e}")
...
def analyze_single_image_phase_b(
    ...
    try:
        ...
        logging.exception(f"[{assessment_id}][img:{image_id}] Error during Phase B: {e}")
