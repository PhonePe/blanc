...
#   • Secrets set in blancService/atm/config/local.yml (or OPENAI_API_KEY env)
#
# Usage: ./native-run.sh
...
[[ -f "${BACKEND_DIR}/atm/config/local.yml" ]] || die "Missing blancService/atm/config/local.yml — run ./native-build.sh."
